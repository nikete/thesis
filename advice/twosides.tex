...
\item The subject observes $c_t$ and ${b}_{t,i}$, picks an action $a_t$, and receives a reward $r_t$. %TODO what is a_t'?
...
Under full disclosure, a repeated version of the Chapter 5 Direct Reward Sharing Mechanism (DRSM) when applied to this chapters Example~\ref{eg:2regimes} has a NE that results in the greedy policy. %TODO this sentence seems to have two endings? choose one.
