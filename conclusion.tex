...
In many cases (perhaps most cases in practice) compliance information can be used to accelerate learning. Unfortunately, however, naively incorporating compliance information leads to algorithms with linear regret.% as seen in example~\ref{eg:rich} and figure~2. 
